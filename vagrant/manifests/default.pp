...
apache::vhost { "fsi-admin-security-bundle.dev":
  server_name   => "fsi-admin-security-bundle.dev",
  serveraliases => [
    "www.fsi-admin-security-bundle.dev"
  ],
  docroot       => "/var/www/admin-security-bundle/features/fixtures/project/web",
  port          => '80',
  env_variables => [
],
  priority      => '1',
